#DE ACUERDO A LOS SIGUIENTES EJEMPLOS DESARROLLE LOS 11 NUMERALES SIGUIENTES PARA SU RESPECTIVA SOLUCION"
...
for i in ciudad:
  if(i[0]=="B"):
    print(i)  
"""
#DE ACUERDO A LOS EJEMPLOS ANTERIORES DESARROLLE LOS SIGUIENTES NUMERALES PARA SU RESPECTIVA SOLUCION Y EL PROBLEMA FINAL"
